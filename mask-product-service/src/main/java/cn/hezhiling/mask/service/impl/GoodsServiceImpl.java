...
import cn.hezhiling.core.utils.StringUtil;
import cn.hezhiling.mask.constant.RedisKey;
import cn.hezhiling.mask.dao.*;
...
import cn.hezhiling.mask.model.vo.GoodsDetailVo;
import cn.hezhiling.mask.model.vo.GoodsPageVo;
import cn.hezhiling.mask.model.vo.GoodsSpecPriceAttrVo;
import cn.hezhiling.mask.model.vo.GoodsVo;
...
//        }
    ...
    public DeferredResult<List<HotSellingGoods>> queryHotSellingGoodsDr(Integer showNum) {
        ...
        Integer finalShowNum = showNum;
        es.submit(() -> {
            List<HotSellingGoods> resultList = new ArrayList<>();
            Integer start = 0;
            Integer end = finalShowNum;
            List<HotSellingGoods> hotSellingGoodsList = queryHotSellingGoods(start, end);
            resultList.addAll(hotSellingGoodsList);
            deferredResult.setResult(resultList);
        });
